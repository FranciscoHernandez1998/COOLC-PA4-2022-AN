...
class method extends Feature {
    ...
    public void code(CgenClassTable codegen_classtable, PrintStream s) {
        ...
        CgenSupport.emitPrologue(3, s); // NOTE: this size depends on number of variables including formals, let variables, case variables, etc...
        expr.code(s);
        CgenSupport.emitEpilogue(3, false,s); // NOTE: this size depends on number of variables including formals, let variables, case variables, etc...
    }
